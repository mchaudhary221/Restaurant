...
public class MainDesign {
	...
	private void initialize() {
		...
		comboBox_1.setBounds(22, 37, 151, 20);
		...
		comboBox_2.setBounds(208, 37, 123, 20);
		...
		comboBox_3.setBounds(22, 75, 151, 20);
		panel.add(comboBox_3);
		
		JComboBox comboBox_4 = new JComboBox();
		comboBox_4.setBounds(208, 75, 123, 20);
		...
		comboBox_5.setBounds(22, 118, 151, 20);
		panel.add(comboBox_5);
		
		JComboBox comboBox_6 = new JComboBox();
		comboBox_6.setBounds(208, 118, 123, 20);
